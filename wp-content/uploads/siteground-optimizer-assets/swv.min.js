(() => {
    ...
    const f = function(b) {
        ...
        l = function(b) {
            if (!b.getAll(this.field).every(a => /^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(a.trim()))) throw new a(this)
        },
        m = function(b) {
    ...
    window.swv = {
        validators: b,
        validate: (d, e, f = {}) => {
            const c = (d.rules ? ? []).filter(({
                rule: a,
                ...c
            }) => "function" == typeof b[a] && ("function" != typeof b[a].matches || b[a].matches(c, f)));
            ...
            return c.reduce((c, f) => {
                ...
                if (c.get(d.field) ? .error) return c;
                try {
                    b[e].call({
                        rule: e,
                        ...d
                    ...
                    if (b instanceof a) return c.set(d.field, b)
                }
                return c.set(d.field, {})
            }, new Map)
        },
